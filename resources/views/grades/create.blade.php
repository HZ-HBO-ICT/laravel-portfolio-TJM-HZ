...
<section class="text-align-left">
    ...
    <form method="POST" action="{{route('grades.index')}}">
        ...
        <div>
            ...
            <div>
                <input type="number" name="lowest_passing_grade" id="lowest_passing_grade">
        ...
        <div>
            ...
            <div>
                <input type="number" name="ec" id="ec">
                <p>{{$errors->first('ec')}}</p>
            </div>
        </div>
        <div>
            ...
            <div>
                <input type="number" name="best_grade" id="best_grade"> <!--TODO / HELP How could I handle this automatically? There is a function for it in the Grade model? -->
